...
-- ----------------------------
INSERT INTO `auth_user` VALUES (1, 'pbkdf2_sha256$390000$Gd4IdahVppfqDje0gYvr99$So4UMdMEzeUXeE6TWkywTDg87yxP2BAs5tZ2I7IEDus=', '2023-03-13 06:51:33.392873', 1, 'admin', '', '', 'admin@qq.com', 1, 1, '2023-03-13 06:51:29.474042');
...
-- ----------------------------
INSERT INTO `django_session` VALUES ('4r3t2vel1vnneocqoow9h20jg82mez1w', '.eJxVjMsOwiAQRf-FtSHQ4enSvd9ABhikaiAp7cr479qkC93ec859sYDbWsM2aAlzZmcm2el3i5ge1HaQ79hunafe1mWOfFf4QQe_9kzPy-H-HVQc9VtHSD4Kp5U3Seg4FURhMCmYjAblQUhMaIVCAsxopbLgqGRFxVqdybH3B9pbN_U:1pbc1t:KmRQTfq-pWITEmfnRSb3rb1R9DFejeRZcNtXzvRDEQQ', '2023-03-27 06:51:33.396835');
...
CREATE TABLE `srcmodel_companyinformation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `company_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_title` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_introduction` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `logo` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `address` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `website` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `srcmodel_department`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `dep_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `srcmodel_leakinformation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `leak_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `leak_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `leak_describe` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `leak_scope` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `leak_harm` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `repair_comments` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `leak_status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `srcmodel_leakinformation_author_id_57ff659d`(`author_id`) USING BTREE,
  INDEX `srcmodel_leakinformation_leak_rank_id_d7115d28`(`leak_rank_id`) USING BTREE,
  INDEX `srcmodel_leakinformation_project_id_ef383a21`(`project_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `srcmodel_leakrank`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `level_name` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `srcmodel_manageuserdetail`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `srcmodel_manageuserdetail_department_id_642e5ff6`(`department_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `srcmodel_project`  (
  ...
  `project_details` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_data` date NOT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `srcmodel_project_business_type_id_fba1a67a`(`business_type_id`) USING BTREE,
  INDEX `srcmodel_project_company_information_id_6c9322cf`(`company_information_id`) USING BTREE,
  INDEX `srcmodel_project_industry_type_id_0bed0688`(`industry_type_id`) USING BTREE,
  INDEX `srcmodel_project_project_status_id_bab6db15`(`project_status_id`) USING BTREE,
  INDEX `srcmodel_project_project_type_id_89dde3f3`(`project_type_id`) USING BTREE,
  INDEX `srcmodel_project_reward_level_id_5c0c05cb`(`reward_level_id`) USING BTREE,
  INDEX `srcmodel_project_reward_type_id_ee952013`(`reward_type_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `srcmodel_project_skill_requirements`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `srcmodel_project_skill_r_project_id_skillrequirem_6a77cf31_uniq`(`project_id`, `skillrequirements_id`) USING BTREE,
  INDEX `srcmodel_project_skill_requirements_project_id_ddd0dc0f`(`project_id`) USING BTREE,
  INDEX `srcmodel_project_skill_requ_skillrequirements_id_b4578d2a`(`skillrequirements_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `srcmodel_user`  (
  ...
  `usertype` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_information_id` bigint(20) NOT NULL,
  `create_name_id` bigint(20) NOT NULL,
  `user_detail_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `company_information_id`(`company_information_id`) USING BTREE,
  UNIQUE INDEX `create_name_id`(`create_name_id`) USING BTREE,
  UNIQUE INDEX `user_detail_id`(`user_detail_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `srcmodel_userdetail`  (
  ...
  `sex` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `birthday` date NOT NULL,
  `diploma` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `occupation` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `introduce` varchar(254) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
